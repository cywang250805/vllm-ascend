...
class AscendFusedMoE(FusedMoE):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # flashcommon3 gate stream is only enabled for shared-expert MoE layers.
    ...
    def forward_impl(  # type: ignore[override]
        ...
        fc3_enabled = self.multistream_overlap_gate and _EXTRA_CTX.flashcomm_v3_enabled
        if not fc3_enabled:
            clear_flash_common3_context()
        ...
        if fc3_enabled:
            ...
            with npu_stream_switch(AscendFusedMoE.gate_stream, enabled=fc3_enabled):
                # share_expert
