...
def register_connector():
    ...
    KVConnectorFactory.register_connector(
        "MooncakeHeterNhdConnector", "vllm_ascend.distributed.kv_transfer.kv_p2p.mooncake_heter_nhd_connector", "MooncakeConnector"
    )

    KVConnectorFactory.register_connector(
        "MooncakeHeterHndConnector", "vllm_ascend.distributed.kv_transfer.kv_p2p.mooncake_heter_hnd_connector", "MooncakeConnector"
    )
