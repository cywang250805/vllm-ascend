...
// Infer aclrtMemcpyKind from src/dst pointer attributes. Used by
// swap_blocks_batch to remove the need for an explicit `direction` arg.
...
void swap_blocks_batch(const torch::Tensor& src_ptrs,
    ...
    // =========================================================================
    // path 2: aclrtMemcpyAsync (fallback / D2D / H2H)
    // =========================================================================
